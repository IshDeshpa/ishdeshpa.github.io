...
\begin{flushleft}
    \sectionItem{Longhorn Racing Solar Car}{Sept 2021 - Present}{Platform Team Lead}{}{
        \begin{itemize}
            \item[\textbullet] Designing hardware \& software developer tooling for use in bench testing: UART/CAN Bootloader, Board Support Package for MCU peripherals, USB Type-C 12V/5V Power Supply
            \item[\textbullet] Streamlining Makefile-based build system for the team's shared codebase 
        \end{itemize}
        \vspace{2.5pt}
        \role{Controls Team Lead}{}{
            \begin{itemize}
                \item[\textbullet] Programmed in an RTOS context for our shared platform of ARM-based STM32F4/L4 microcontrollers
                \item[\textbullet] Interfaced with display, pedals, lights, and motor controller
                \item[\textbullet] Managed a team of 12 through a traditional software workflow with Git/GitHub
            \end{itemize}
        }
    }
...
\begin{flushleft}
    \rule{\textwidth}{1pt}
    \underline{Skills:} C/C++, KiCAD, Linux, Python, OS \& RTOS Development, Git, Java \\
