...
\begin{flushleft}
    ...
    \textbf{Relevant Coursework:} Embedded Systems Lab, Compilers, Operating Systems, Digital Logic Design, ML/HW Codesign, Computer Architecture, Algorithms, Data Science Lab, RTOS, VLSI, Graphics,
\end{flushleft}
