...
\begin{flushleft}
    ...
    \textbf{Relevant Coursework:} Embedded Systems Lab, Operating Systems, Digital Logic Design, ML/HW Codesign, Computer Architecture, Algorithms, Data Science Lab, RTOS, VLSI, Graphics, Systems for Machine Learning, Compilers \\
\end{flushleft}
...
\begin{flushleft}
    \rule{\textwidth}{1pt}
    \underline{Skills:} C, KiCAD, Python, Verilog, Vitis HLS, Kernel Development, Application Development for RTOS, Linux, Git, Docker, AWS, Java \\
