...
\begin{flushleft}
    ...
    \textbf{M.S. in Electrical and Computer Engineering (Spec. Embedded Systems)} \hfill \textbf{December 2026} \\
    \textbf{B.S. in Electrical and Computer Engineering} \hfill \textbf{May 2025} \\
    \textit{3.79 Undergraduate GPA, 3.75 Graduate GPA} \\
    \textbf{Relevant Coursework:} Embedded Systems Lab, Digital Logic Design, ML/HW Codesign, Comp. Arch., Algorithms, Distributed Systems, Multithreaded Programming, RTOS, VLSI, Graphics, ML Systems, Compilers \\
\end{flushleft}
...
\begin{flushleft}
    \sectionItem{Apple}{May 2026 - Aug 2026}{Embedded Intern}{Cupertino, CA}{
        \begin{itemize}
        \item Cut firmware memory footprint by shipping a lockless, interrupt-safe thread-pooling primitive for sharing OS thread stacks
        \item Quantified memory and performance tradeoffs across firmware subsystems, informing an adoption rollout plan
        \end{itemize}
    }
...
\begin{flushleft}
    ...
    \sectionItem{UT Real-Time Operating Systems Graduate Project}{Apr 2025}{Embedded Software Engineer}{}{
        \begin{itemize}    
            \item Interfaced with a Wifi-Ethernet bridge chip and wrote MAC, IP, UDP, ICMP, ARP, and DHCP drivers from scratch on a TI microcontroller
...
\begin{flushleft}
    \rule{\textwidth}{1pt}
    \underline{Skills:} C/C++, KiCAD, Kernel Development, Python, Verilog, Vitis HLS, Application Development for RTOS, Linux, Git, Docker, AWS, Java \\
