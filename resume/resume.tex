...
\begin{flushleft}
    ...
    \textbf{Relevant Coursework:} Embedded Systems Lab, Digital Logic Design, ML/HW Codesign, Computer Architecture, Algorithms, Advanced OS, RTOS, VLSI, Graphics, ML Systems, Compilers \\
\end{flushleft}
